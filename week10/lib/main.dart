...
/// Minimal replacements for the missing `baseflow_plugin_template` package
/// used by the example app. These provide the small surface needed by this
/// file: ExamplePage, BaseflowPluginExample and a createMaterialColor helper.
...
class BaseflowPluginExample extends StatelessWidget {
  ...
  /// Simple implementation to create a MaterialColor from a single Color.
  static MaterialColor createMaterialColor(Color color) {
    ...
    for (var strength in strengths) {
      final intStrength = (strength * 1000).round();
      swatch[intStrength] = Color.lerp(Colors.white, color, strength) ?? color;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      title: pluginName,
      theme: ThemeData(primarySwatch: createMaterialColor(const Color.fromRGBO(48, 49, 60, 1))),
      home: Scaffold(
        appBar: AppBar(
          title: Text(pluginName),
          actions: appBarActions,
        ),
        body: page != null ? Builder(builder: page.builder) : const SizedBox(),
      ),
    );
  }
}
